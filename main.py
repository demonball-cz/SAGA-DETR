...
from util.engine import append_epoch_metrics, evaluate_acc, train_one_epoch_acc
...
def train():
    ...
    for epoch in range(cfg.starting_epoch, cfg.num_epochs):
        ...
        append_epoch_metrics(cfg.output_dir, epoch, train_metrics, coco_evaluator, accelerator)
